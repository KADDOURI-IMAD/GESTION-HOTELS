...
<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            <h3 class="h-font fw-bold fs-3 mb-2"><?php echo $contact_rr['site_title'] ?></h3>
            <p>
                Lorem ipsum dolor sit amet,
                consectetur adipisicing elit.
                Libero magnam perspiciatis dicta
                perferendis ipsum in eligendi
                repellendus officia minus
                temporibus.
            </p>
        </div>
        <div class="col-lg-4 p-4">
        ...
        <div class="col-lg-4 p-4">
            ...
            if($contact_r['twit']!=''){
                echo<<<data
                <a href=" $contact_r[twit]" class="d-inline-block text-dark text-decoration-none mb-2"><i class="bi bi-twitter me-1"></i>Twitter</a><br>
                data;
            }
            ?>
...
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by KADDIMD</h6>
     ...
     e.preventDefault();
        ...
        xhr.onload = function () {
            if (this.responseText == 'inv_email') {
                ...
                alert('error','Cannot isend email! Server Down');
            }else if (this.responseText == 'upd_failed') {
