...
<html lang="an">
  <head>
    ...
    <title>Star Hotel - CONFIRM BOOKING</title>
...
<div class="container">
  ...
  <div class="col-12 my-5 mb-4 px-4">
    ...
    <div class="col-lg-7 col-md-12 px-4">
        ...
        echo<<<data
          <div class="cred p-3 shadow-sm rounded">
          <img src="$room_thumb" class="img-fluid rounded mb-3">
          <h5>$room_data[name]</h5>
          <h6>$room_data[price] MAD per night</h6>
          </div>
        data;
        ?>
    </div>
    ...
    <div class="card-body">
      <form action="pay_now.php" method="POST" id="booking_form">
        ...
        <div class="col-md-6 mb-3">
           ...
           <input name="name" type="text" value="<?php echo $user_data['fname'] . ' ' . $user_data['lname']; ?>" class="form-control shadow-none" required>
        </div>
          <div class="col-md-6 mb-3">
          ...
          <div class="col-12">
            ...
            <h6 class="mb-3 text-dark" id="pay_info">Provide check-in & check-out date!</h6>
  ...
  info_loader.classList.remove('d-none');
      ...
      xhr.onload = function() {
        ...
        if (data.status === 'check_in_out_equal') {
          ...
          pay_info.innerHTML = "No of Days: " + data.days + "<br>Total Amount to Pay: " + data.payment + " MAD";
